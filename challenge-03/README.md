...
*/
var pessoa= {nome:'Breno', sobrenome:'Oliveira', sexo:'masculino', idade:22, altura:1.90,peso:80,andando:false, caminhouQuantosMetros:0 }
...
pessoa.apresentacao = function()
{
	...
	if (pessoa.sexo ==='masculino' && pessoa.idade > 1){
        return 'Olá, eu sou o ' +pessoa.nome+' '+pessoa.sobrenome+', tenho '+pessoa.idade +' anos, meço '+pessoa.altura + ', meu peso é' +pessoa.peso+' e, só hoje, eu já caminhei 			  		   			'+pessoa.caminhouQuantosMetros+' metros!';
